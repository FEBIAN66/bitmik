...
case 'sendbug':
        ...
        case 'creator':
               ...
               await sleep(1000)
               sendKontak(from, `${owner}`, `RAVA STORE`, 'Sibukk!!')
               await sleep(1000)
               txtt =`Hai Kak ${pushname}\nItu Ownerku, Mau tau soal apa ya?`

               buttons = [{buttonId: '!sourcecode',buttonText:{displayText: 'SC BOT'},type:1},{buttonId:'!sewabot',buttonText:{displayText:'SEWA BOT👑'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INSTAGRAM'},type:1}]
...
`
			...
			reply(`
*Jangan lupa Join Group Official _MIKELBOT_*

*[Group 1 Jb]*
*https://chat.whatsapp.com/FVIlHQHgIgpC5s5105V3eK
*[Group 2 Jb]*
https://chat.whatsapp.com/Bdp7X5OFgyd95zrMmCn3L2

*ADD EP EP CREATOR*
*574033894*

*Follow IG Creator*
**instagram.com/pebian_store*

_Gunanya untuk pengetahui informasi apabila ada penggantian Nomor *MIKELBOT*, Dan informasi lainnya._`)
		}, 2000)
...
ikyy.sendMessage(from, loli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'MIKEL BOT', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙MENU SIMPLE' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: 'OWNER 👑' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
        ...
        "productSections": [
          {
            ...
            "products": [
              {
                "productId": "4877846978910427"
              },
              {
              	"productId": "6897456440280356"
              },
              {
              	"productId": "4613668955334004"
              }
            ]
          }
        ],
        "headerImage": {
          "productId": "4192970574085820",
